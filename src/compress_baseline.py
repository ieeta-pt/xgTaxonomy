...
# ,"bzip2","Cmix","GeCo3","gzip","JARVIS","MFCompress","NAF","NUHT","pufferfish","UHT","unzip","xz","zstd"]
    ...
    writeCSVLine(["Domain","blzpack_comp","bsc_comp","bzip2_comp","Cmix_comp","GeCo3_comp","gzip_comp",
            "JARVIS_comp","lizard_comp","lz4_comp","lzo_comp","mbgc_comp","MFCompress_comp",
            ...
            "lizard_time", "lz4_time", "lzo_time", "mbgc_time","MFCompress_time",
    ...
    for domain in listdir(mergedPath):
        ...
        for fileName in listdir(join(mergedPath, domain)):
            ...
            csvEntry = {
                ...
                "JARVIS_comp": None,"lizard_comp": None,"lz4_comp": None,"lzo_comp": None,"mbgc_comp": None,"MFCompress_comp": None,
                ...
                "JARVIS_time": None,"lizard_time": None, "lz4_time": None, "lzo_time": None, "mbgc_time": None,"MFCompress_time": None,
